...
// Updated prompt constructor to take userDescription context
const PROMPT = (cropType, userDescription) => `আপনি একজন বিশেষজ্ঞ উদ্ভিদ রোগ বিশেষজ্ঞ। এই ${cropType} পাতার ছবি বিশ্লেষণ করুন।
 ...
 */
export async function analyzeCropImage(base64Image, mimeType, cropType, userDescription = '') {
  let lastError
        ...
        contents: [
          {
            parts: [
              ...
              { text: PROMPT(cropType, userDescription) },
            ],
          },
        ],
      })
