...
const PROMPT = (cropType, plantPart, userDescription) => {
 ...
 */
export async function analyzeCropImage(base64Image, mimeType, cropType, userDescription = '', plantPart = 'leaf') {
  let lastError
        ...
        contents: [
          {
            parts: [
              ...
              { text: PROMPT(cropType, plantPart, userDescription) },
            ],
          },
        ],
      })
